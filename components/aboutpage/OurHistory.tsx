export default function OurHistory() {
    return (
        <section id="our-history-section">
            <div className="!flex !flex-col !px-14 !pt-20 !pb-10 !mx-auto !max-w-7xl !items-start">
                <p className="!text-[#3a3838] !text-base !leading-relaxed !mb-4 !uppercase !text-justify !pt-20">
                    Our History
                </p>
            ...
            <div className="!flex !flex-col !px-14 !pt-10 !pb-10 !mx-auto !max-w-7xl !w-full !items-start">
