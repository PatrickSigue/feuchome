...
export function Dir1() {
    return(
        <>
            <div className='row pt-[15vh] pl-[15vh] row-exec'>
                <div className='column flex-3'>
                    ...
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            ...
                            <h6>CHRISTMER ROLAND ORDANES</h6>
                            <h6>OFFICE OF THE PRESIDENT</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-7  !justify-end pl-[10vw]'>
                    <div className='border-b-10 !border-[#d0ad22]'>
                        <img src="/rando/2.jpg" className='!w-full aspect-3/1 object-cover object-center h-[30vh] mt-[2vh] grayscale'alt="image" />
                    </div>                
                </div>
            </div>
            ...
            <div className='row row-exec'>
                ...
                <div className='column flex-1'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Assoc. Director</h4>
                            <h6>CZARINA LILY BEATRICE LUZ</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Assoc. Director</h4>
                            <h6>ALESSANDRA JOYCE CUZZAMU</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
    ...
    return(
        <>
            <div className='row row-exec pt-[15vh] pl-[15vh]'>
                <h2 className='leading-none !font-bold'>EXTERNAL<br />COMMUNICATIONS</h2>
            </div>
            <div className='row row-exec pt-[5vh]'>
                <div className='column flex-1 pl-[15vh]'>
                    <div className='row'>
                        <img src="/about/dir2/1.png" className='aspect-4/5 object-cover object-top h-[20vh] mt-[2vh] rounded-2xl'alt="image" />
                        <div className='column pl-[1vw]'>
                            <h4>Director</h4>
                            <h6>ANGELICA LYN SANCHEZ</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
                ...
                <div className='column flex-1'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Assoc. Director</h4>
                            <h6>CHRISTINE ESCAME</h6>
                        </div>
                    </div>
                </div>
            </div>
            <div className='exec-pad !mt-[46vh]'></div>
        </>
    );
}
            ...
            <div className='row row-exec'>
                <div className='column flex-1 pl-[15vh]'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Director</h4>
                            <h6>CHRISTIAN JAMES NAMBATAC</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
            ...
            <div className='row row-exec pt-1'>
                ...
                <div className='column flex-1'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Assoc. Director</h4>
                            <h6>CHRISTIANNA MARI MIRANDA</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
            ...
            <div className='row row-exec pt-1'>
                <div className='column flex-1 pl-[15vh]'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Director</h4>
                            <h6>REIGH ANNE MARGARET BAUTISTA</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
            ...
            <div className='row row-exec'>
                <div className='column flex-1 pl-[15vh]'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Director</h4>
                            <h6>HAILIE ANNE MARIE TOLENTINO</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
            ...
            <div className='row row-exec pt-1'>
                <div className='column flex-1 pl-[15vh]'>
                    <div className='row'>
                        ...
                        <div className='column pl-[1vw]'>
                            <h4>Director</h4>
                            <h6>KEAN JEFF NARCISO MAPUTOL</h6>
                        </div>
                    </div>
                </div>
                <div className='column flex-1'>
